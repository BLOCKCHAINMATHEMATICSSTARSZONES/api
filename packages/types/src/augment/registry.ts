...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<ExtrinsicsRoot>': Option<ExtrinsicsRoot>;
    ...
    'Vec<ExtrinsicsRoot>': Vec<ExtrinsicsRoot>;
